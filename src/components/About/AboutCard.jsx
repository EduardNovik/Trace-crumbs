...
const AboutCard = () => {
    ...
    return (
      ...
      <Stack direction={'row'} sx={{mt:'-40px',  gap:'40px', justifyContent:'center', flexDirection: { xs: "column", md: "column" },}}>
            <Box component='img' src={photoAbout} alt='myPhoto' sx={{ objectFit:'cover', width:'100vw', maskImage:'linear-gradient(to top, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 40%)'}}/>
            <Box sx={{ display:'grid' }}>
                <Typography 
            ...
            <Item id='aboutTextBlock' sx={{ width:'55%', borderRadius:'10px', m:'0 auto', mb:'100px',textAlign:'left'}}>
